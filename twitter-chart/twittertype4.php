...
if(preg_match($isjs,$user)) {
  ...
  $resp = $cache->getData('twitter',$url);
  ...
  $image = get('http://chart.apis.google.com/chart?cht=p3&chco=F2E353,FFA305,54688E&'.'chtt='.urlencode($title).'&chd=t:'.$values.'&chs=270x100&chl='.$labels);
